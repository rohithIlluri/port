    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative bg-white/70 backdrop-blur-sm border border-black/5 rounded-lg shadow-sm hover:shadow-md transition-all duration-500 p-8 lg:p-10">
        <div className="relative z-20">
          ...
          <div className="bg-white/95 backdrop-blur-sm border border-black/8 rounded-md p-6 space-y-6 shadow-md hover:shadow-lg transition-all duration-300">
            <div>
            ...
            {selectedRepo && (
              <div className="bg-white/95 backdrop-blur-sm border border-black/10 rounded-md p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
