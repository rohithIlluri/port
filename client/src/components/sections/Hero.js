      ...
      <div className="bg-white p-6 lg:p-8 relative z-20 shadow-lg border border-gray-200 rounded-2xl hover:shadow-xl transition-all duration-500">
        <div className="text-center lg:text-left">
          ...
          {/* <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start group-hover:scale-105 transition-transform duration-300">
            ...
            >
              <svg className="w-4 h-4 mr-2 group-hover/btn:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            >
              <svg className="w-4 h-4 mr-2 group-hover/btn:scale-125 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
